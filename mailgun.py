...
def analyticsmain():
	...
	redirect(url_for(forward_method))
...
def getCampaign():
	...
	return render_template('result.html',data=data.text)
...
@app.route("/getCampaignstats",methods=['GET'])
def getCampaignstats():
	...
	if _campaignId:
		...
		mg = Mailgun()
		data= mg.get_campaign_stats(_campaignId)
		# if data == "400":
		# 	return "Some thing went wrong while Retrieving Data"
		# else:
		return data	
...
@app.route("/getCampaignStatsDaily",methods=['GET'])
def getCampaignStatsDaily():
...
@app.route("/getCampaignStatsCity",methods=['GET'])
def getCampaignStatsCity():
	...
	if _campaignId:
		...
		mg = Mailgun()
		data= mg.get_campaign_stats_city(_campaignId)
		# if data == "400":
		# 	return "Some thing went wrong while Retrieving Data"
		# else:
		return data	
...
@app.route("/getCampaignStatsRegion",methods=['GET'])
def getCampaignStatsRegion():
...
@app.route("/getClicksToplinks",methods=['GET'])
def getClicksToplinks():
...
@app.route("/getClicksIndividual",methods=['GET'])
def getClicksIndividual():
